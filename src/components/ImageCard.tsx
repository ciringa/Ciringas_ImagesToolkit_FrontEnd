export default function ImageCard(Title:string){
    return(
        <>
            <div className="transform transition duration-300 hover:scale-110 rounded-lg shadow-lg h-52 w-56 sm:w-2/3 hover:shadow-xl bg-white">
