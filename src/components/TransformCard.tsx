        ...
        <div className="relative sm:w-2/3 flex w-1/2 flex-col rounded-xl bg-slate-900 bg-clip-border text-gray-300 shadow-md">
            ...
            <div className="p-6">
                ...
                <p className="block font-sans text-base font-light leading-relaxed text-inherit antialiased">
                    Envie uma imagem para alterar sua escala utilizando técnicas avançadas.
                </p>
            </div>
            <div className="p-6 pt-0">
                <form className="mt-10 flex w-full flex-col justify-center items-center gap-y-6" action="http://127.0.0.1:4545/image/rescale" method="post" encType="multipart/form-data" id="form3">
                    <input type="file" name="avatar" id="sub_file3" className=" appearance-none text-center flex flex-row"/>
                    <input name="scale"type="number" min={0} max={100} defaultValue={1} className=" text-sm shadow-md shadow-blue-500/20 font-bold rounded-md p-4 text-center outline-none border-none h-10 bg-blue-500 w-36"></input>
